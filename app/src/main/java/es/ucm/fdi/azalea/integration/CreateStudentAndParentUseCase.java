...
public class CreateStudentAndParentUseCase {
    ...
    public void execute(StudentModel sm, UserModel parent, CallBack<Boolean> cb) {
        getCurrentUser(sm, parent, new CallBack<Boolean>() {
            @Override
    ...
    public void getCurrentUser(StudentModel student, UserModel parent, CallBack<Boolean> cb) {
        try {
            BusinessFactory.getInstance().getAuthRepository().getCurrUser(new CallBack<FirebaseUser>() {
                ...
                public void onSuccess(Event.Success<FirebaseUser> success) {
                    ...
                    getUserModel(success.getData().getUid(), student, parent, cb);
                }
    ...
    public void getUserModel(String id, StudentModel student, UserModel parent, CallBack<Boolean> cb) {
        ...
        try {
            BusinessFactory.getInstance().getUserRepository().findById(id, new CallBack<UserModel>() {
                ...
                public void onSuccess(Event.Success<UserModel> success) {
                    ...
                    readClassRoomById(success.getData().getClassId(), student, parent, cb);
                }
    ...
    public void readClassRoomById(String classId, StudentModel student, UserModel parent, CallBack<Boolean> cb) {
        BusinessFactory.getInstance().getClassRoomRepository().readById(classId, new CallBack<ClassRoomModel>() {
            ...
            public void onSuccess(Event.Success<ClassRoomModel> success) {
                ...
                checkUserExists(student, parent, cb);
            }
    ...
    public void checkUserExists(StudentModel student, UserModel parent, CallBack<Boolean> cb) {
        BusinessFactory.getInstance().getUserRepository().checkUserExists(parent.getEmail(), new CallBack<Boolean>() {
            ...
            public void onError(Event.Error<Boolean> error) {
                ...
                createStudent(student, parent, cb);
            }
        });
    }
    // Paso 5: Crear el estudiante

    public void createStudent(StudentModel student, UserModel parent, CallBack<Boolean> cb) {
    ...
    private void register(StudentModel student, UserModel parent, CallBack<Boolean> cb) {
        BusinessFactory.getInstance().getAuthRepository().register(parent.getEmail(), parent.getPassword(), new CallBack<UserModel>() {
            ...
            public void onSuccess(Event.Success<UserModel> success) {
                ...
                registerUser(student, parent, cb);
            }
    ...
    private void registerUser(StudentModel student, UserModel userdata, CallBack<Boolean> cb) {
        BusinessFactory.getInstance().getUserRepository().create(userdata, new CallBack<UserModel>() {
            ...
            public void onSuccess(Event.Success<UserModel> success) {
                ...
                updateStudent(student.getId(), student, cb);
            }
