...
public class ParentActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        parentViewModel.getEventsForClassroom("2"); // TODO CAMBIAR ESTO POR EL ID DE LA CLASE CORRESPONDIENTE
        parentViewModel.getEventsForClassroomLiveData().observe(this, this::paintDaysWithEvents);
        ...
        parentViewModel.getEventsForDate(formattedDate);
